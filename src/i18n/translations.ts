...
export const messages: Record<AppLocale, LocaleMessages> = {
  ...
  es: {
    ...
    header: {
      ...
      clearConfirmDescription:
        "Esta accion elimina todos los campos, secciones y contenido actual. No se puede deshacer.",
      confirmAction: "Si, reiniciar",
    ...
    preview: {
      presetsLayout: "Presets y Diseno",
      show: "Mostrar",
      hide: "Ocultar",
      zoomIn: "Acercar",
      zoomOut: "Alejar",
    ...
    editor: {
      ...
      currentlyHere: "Trabajo actualmente aqui",
      bullets: "Puntos",
      ...
      techComma: "Tecnologias (separadas por coma)",
      issuer: "Emisor",
      date: "Fecha",
      emptyExperience: "Aun no hay experiencia.",
      emptyEducation: "Aun no hay educacion.",
      emptySkills: "Aun no hay habilidades.",
      emptyProjects: "Aun no hay proyectos.",
      emptyLanguages: "Aun no hay idiomas.",
      emptyCertifications: "Aun no hay certificaciones.",
      levelNative: "Nativo",
      levelFluent: "Fluido",
      levelIntermediate: "Intermedio",
      levelBasic: "Basico",
      placeholderName: "Julian Perez",
    ...
    avatar: {
      ...
      description:
        "Sube una foto o toma una con camara, luego ajusta forma, bordes y efectos para el PDF.",
      ...
      cameraError: "No se pudo abrir la camara. Revisa permisos del navegador.",
    ...
    sectionAliases: {
      ...
      "System Overview": "Vision del sistema",
      Experience: "Experiencia",
      ...
      "Research Projects": "Proyectos de investigacion",
      ...
      Studies: "Estudios",
      Work: "Trabajo",
      "Research Statement": "Declaracion de investigacion",
      "Research / Projects": "Investigacion / Proyectos",
    ...
    common: {
      ...
      yourName: "Tu Nombre",
      role: "Rol",
      professionalResume: "Curriculum profesional",
    },
    templateCategories: {
    ...
    fontNames: {
      classic: "Editorial Clasico",
      modern: "Sans Moderno",
      editorial: "Editorial Refinado",
      tech: "Mono Tech",
      elegant: "Serif Elegante",
      bold: "Declaracion Intensa",
      geometric: "Geometrico Limpio",
    ...
    paletteNames: {
      ...
      "charcoal-pro": "Carbon Profesional",
      ...
      "warm-gray": "Gris Calido",
      "sepia-classic": "Sepia Clasico",
      "nordic-ice": "Hielo Nordico",
      "harvard-crimson": "Carmes Harvard",
